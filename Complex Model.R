...
numindiv.V  = c(20,50,100)                      #start off with a number of individuals 
numsteps.V  = c(20,50,100)           #number of steps individuals will take 
move.V      = 0.95                       #Likelihood of individuals moving to the next cell 95% of the time they will move 
numcamera.V = 100  #c(5,25,100,250)            #number of cameras placed on the landscape
camerror.V  = 0.01 #c(0.001, 0.01, 0.1)        #prop of incorrect IDs using camera
numgen.V    = 100  #c(5,25,100,250)            #number of genetic samples taken over time
generror.V  = 0.01 #c(0.001, 0.01, 0.1)        #prop of incorrect IDs using genetic samples
